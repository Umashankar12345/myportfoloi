...
function App() {
  ...
  useEffect(() => {
    const lines = [
      ...
      '> Solving complex problems with DSA expertise',
      '> Building AI-driven agricultural solutions...',
    ...
    <div className="App">
      ...
      <nav>
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="nav-logo" onClick={(e) => handleNavClick(e, 'home')} style={{ cursor: 'pointer' }}>&lt;UK /&gt;</div>
          <div className="hidden md:flex gap-6">
            <button onClick={(e) => handleNavClick(e, 'about')} className="nav-link">ABOUT</button>
            <button onClick={(e) => handleNavClick(e, 'education')} className="nav-link">EDUCATION</button>
            ...
            <button onClick={(e) => handleNavClick(e, 'training')} className="nav-link">TRAINING</button>
            <button onClick={(e) => handleNavClick(e, 'certificates')} className="nav-link">CERTIFICATES</button>
        ...
        <div className="max-w-6xl mx-auto w-full flex flex-col lg:flex-row items-center gap-14 pt-24">
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: 'flex', gap: '.75rem', flexWrap: 'wrap' }}>
              ...
              <a href="/Umashankar_Kumar_Resume.pdf" download className="nbtn nbtn-o">📄 RESUME</a>
            </div>
